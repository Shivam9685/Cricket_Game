...
pygame.display.set_caption("Shivam Ground Cricket Live")
...
bat2 = batsman('V.Kohli',1)
bat3 = batsman('S.Raina',0)
bat4 = batsman('S.Yadav',1)
bat5 = batsman('MS Dhoni',1)
...
def gameloop():
    ...
    if play_choice == 'IND':
        batsmen[0].name, batsmen[1].name, batsmen[2].name, batsmen[3].name, batsmen[4].name, batsmen[5].name = 'R.Sharma', 'V.Kohli', 'S.Raina', 'S.Yadav', 'MS Dhoni', 'H.Pandya'
        batsmen[6].name, batsmen[7].name, batsmen[8].name, batsmen[9].name, batsmen[10].name = 'R.Jadeja', 'S.Thakur', 'W.Sundar', 'B.Kumar','J.Bumrah'
        batsmen[0].kind, batsmen[1].kind, batsmen[2].kind, batsmen[3].kind, batsmen[4].kind, batsmen[5].kind = 1,1,0,1,0,1
